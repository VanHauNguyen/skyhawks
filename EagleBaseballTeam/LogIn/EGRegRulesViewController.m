...
- (void)viewDidLoad {
    ...
    <body>\
        <div class='content'>\
            <h1>註冊台鋼雄鷹 APP 需要提供哪些資訊？</h1>\
            <p>感謝您註冊台鋼雄鷹 APP！為了確保帳戶安全、提供完整的球迷服務，以及符合相關法規要求，我們需要您提供部分個人資訊。這些資訊將僅用於官方授權範圍內，並依照 <a href='privacy_policy' class='link'>台鋼雄鷹隱私權政策</a> 及 <a href='terms_of_service' class='link'>服務條款</a> 進行保護與管理，不會用於未經授權的用途。</p>\
            <p>我們蒐集的資訊與其用途如下：</p>\
            <div class='section'>\
                <h2>一、身分證字號</h2>\
            ...
            \
            <p class='footer'>若有任何疑問，請聯絡台鋼雄鷹官方客服，我們將竭誠為您服務！</p>\
        </div>\
    </body>\
    </html>";
