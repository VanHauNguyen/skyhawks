...
-(void)createUI{
    ...
    [self.settingDic setObject:@"I’m IN!I’m 鷹!我們是台鋼雄鷹!" forKey:@"showText"];
    [self.settingDic setObject:@"0" forKey:@"showBackgroundcolor_r"];
    [self.settingDic setObject:@"122" forKey:@"showBackgroundcolor_g"];
    [self.settingDic setObject:@"96" forKey:@"showBackgroundcolor_b"];
    ...
    searchTextF.text = @"I’m IN!I’m 鷹!我們是台鋼雄鷹!";
    ...
    [bt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    self.quanleidabt = bt;
    
    bt = [[LXYHyperlinksButton alloc] initWithFrame:CGRectMake(20, 150, 72, 32)];
    bt.titleLabel.font = [UIFont boldSystemFontOfSize:FontSize(14)];
    [bt setTitle:@"台鋼雄鷹" forState:UIControlStateNormal];
    [bt addTarget:self action:@selector(setText:) forControlEvents:(UIControlEventTouchUpInside)];
    bt.tag = 30003;
    [self.baseView addSubview:bt];
    [bt mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    collectionView.backgroundColor= [UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0];
...
-(void)updateUI
{
    ...
    [self.One_X_bt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    [self.Two_X_bt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    ...
    [self.smallbt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    [self.middlebt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    ...
    [self.sanzhenbt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    [self.quanleidabt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    [self.taigangxiongyingbt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    [self.jiayoubt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    [self.chibangyinglebt setColor:[UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0]];
    switch (phraseIndex) {
        case 0:
        {
...
-(void)setText:(LXYHyperlinksButton*)bt
{
    ...
    switch (bt.tag) {
        ...
        {
            [self.taigangxiongyingbt setColor:[UIColor whiteColor]];
            [self.settingDic setObject:@"台鋼雄鷹" forKey:@"showText"];
...
- ( UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.item<self.All_Array.count)
    {
        ...
        if([[All_dic objectForKey:@"hightlight"] intValue]==0){
            ...
            cell.baseView.backgroundColor = [UIColor colorWithRed:0 green:71.0/255.0 blue:56.0/255 alpha:1.0];
        }
        else{
