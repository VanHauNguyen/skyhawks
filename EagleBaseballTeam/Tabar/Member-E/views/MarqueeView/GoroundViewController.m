...
- (void)viewDidLoad {
    ...
    else
    {
        ...
        [self.MarqueeDic setObject:@"I’m IN!I’m 鷹!我們是台鋼雄鷹!" forKey:@"showText"];
        
        [self.MarqueeDic setObject:@"244.0" forKey:@"showBackgroundcolor_r"];
        [self.MarqueeDic setObject:@"237.0" forKey:@"showBackgroundcolor_g"];
        [self.MarqueeDic setObject:@"84.0" forKey:@"showBackgroundcolor_b"];
        ...
        [self.MarqueeDic setObject:@"244.0" forKey:@"showBackgroundcolor_original_r"];
        [self.MarqueeDic setObject:@"237.0" forKey:@"showBackgroundcolor_original_g"];
        [self.MarqueeDic setObject:@"84.0" forKey:@"showBackgroundcolor_original_b"];
