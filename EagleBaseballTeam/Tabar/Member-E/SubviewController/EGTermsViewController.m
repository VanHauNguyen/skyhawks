...
//    self.navigationItem.title = @"使用者條款";
    ...
    if ([self.navigationItem.title isEqualToString:@"使用者條款"]) {
        ...
        <body>\
            <div class='content'>\
                <h1>TSG Hawks 使用者條款</h1>\
                <p>歡迎您來到台鋼雄鷹APP(以下簡稱本APP)，當您使用本APP時，即表示您已閱讀、瞭解並同意接受本APP之所有服務聲明之內容(包括但不限於服務聲明內容有任何修改或變更)。若您無法確實遵守服務聲明內容或對於服務聲明內容之全部或部份不同意時，請您立即停止使用本APP。若您未滿十八歲或無完全行為能力者，須經由您的法定代理人(監護人)閱讀、瞭解並同意服務聲明內容後，方得使用本APP所提供的服務；當您開始使用本APP所提供之服務時，則視為您的法定代理人(監護人)亦已閱讀、瞭解並同意服務聲明內容(包括但不限於服務聲明內容有任何修改或變更)。 </p>\
                ...
                <h2>六、本APP所使用之軟體程式及本APP上所有內容，包括但不限於文字、圖片、檔案、資訊、網站架構、報導、專欄、照片、插圖、影像、錄音、畫面的安排、網頁設計等，均由台鋼雄鷹棒球隊股份有限公司（以下簡稱本公司）或其他權利人依法擁有其所有權與智慧財產權（包括但不限於商標權、專利權、著作權、營業秘密、及技術等），任何人與您不得逕自使用、修改、重製、公開播送、公開傳輸、公開演出、改作、散布、發行、公開發表、進行還原工程、解編、反向組譯或為任何違反法令之行為。 </h2>\
                <h2>七、若您欲引用或轉載前述軟體、程式或網站內容，除明確為法律所許可者外，必須依法取得台鋼雄鷹棒球隊股份有限公司或其他權利人的事前書面同意。尊重智慧財產權及法令規定是您應盡的義務，如有違反，您應對本公司或第三人負起民刑事法律責任。本APP為行銷宣傳服務內容，就服務內容相關之商品或服務名稱、圖樣等，依其註冊或使用之狀態，享有智慧財產權及相關法令規定之保護，在未經本公司事前書面許可或其他權利人授權之前，您同意不以任何方式使用。本系統上所刊載內容之圖片浮水印、商標或其他聲明，嚴禁更改或移除。 </h2>\
        ...
        htmlString =@"<!DOCTYPE html>\
            ...
            <body>\
                <div class='content'>\
                    <h1>台鋼雄鷹會員註冊隱私權聲明</h1>\
                    <p>【使用本服務的同意條款與註冊義務】</p>\
                    <p>當會員（以下簡稱甲方）瀏覽或使用【台鋼雄鷹官方APP】所提供之服務，即表示您已詳細閱讀並同意遵守以下所有規範及條款。</p>\
                    <h2>一、會員註冊與使用規範</h2>\
                    <p>當您註冊成為【台鋼雄鷹 APP】會員（以下簡稱會員），即表示您已閱讀、理解並同意遵守本服務條款及隱私權政策之內容。</p>\
                    ...
                    <p>若會員所提供資料經查證有不實、遺漏或未即時更新，台鋼雄鷹有權暫停或終止會員帳號及服務，直至會員完成資料補正。</p>\
                    ...
                    <p>台鋼雄鷹股份有限公司及其委託或合作之第三方（如票務、物流、金流、資訊處理等合作廠商）。</p>\
                    ...
                    <h2>六、兒童個人資料保護</h2>\
                    <p>本網站無意在未經兒童父母或未成年人之法定代理人同意前，向12歲以下兒童或未成年人蒐集任何個人資料，惟如任何十二歲以下兒童或未成年人自願於本網站加入會員或參加台鋼雄鷹相關網路活動時，台鋼雄鷹將因此取得該名兒童或未成年人所提供之姓名、地址及電話等會員或活動所需之資料（以下簡稱「兒童個人資料」）。關於所蒐集來的兒童個人資料，將僅限依據本隱私權聲明規定使用。台鋼雄鷹提請家長對其子女在使用網際網路時個人訊息的使用進行監管和負責，如兒童或未成年人通過公告版或類似形式自願提供及公開的資料被他人使用或發放郵件，與本APP無關。</p>\
                </div>\
            </body>\
            </html>";
