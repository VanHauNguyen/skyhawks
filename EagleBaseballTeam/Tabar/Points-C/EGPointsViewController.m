...
//    config[@"footerContent"] = taskInfo[@"footerContent"];
    ...
    if ([config[@"status"] isEqualToString:@"領取"] ) {
        [MBProgressHUD showDelayHidenMessage:[NSString stringWithFormat:@"正在領取 + %ld 雄鷹點",self.AddPoints]];
        if (completion) {
            completion(NO);
        }
    ...
    self.limitedTasks = [NSMutableArray arrayWithArray:@[
        @{
            ...
            @"taskDetail":@{
                ...
                @"cellContents":@[
                    ...
                    @"第一次登入雄鷹 APP 的球迷可立即獲得超值點數！不僅是賽事速報，還有專屬活動等你來參與！",
                    @"5",
                    @[@"參加資格：活動期間內，首次登入雄鷹 APP 的球迷即可獲得點數。",
                      @"活動達成條件：成功登入並完成註冊，即可獲得點數獎勵。",
                      @"點數發送：比賽結束後 24 小時內，自動發放至會員帳戶，可於 App 查詢點數並兌換獎品。"],
        ...
        @{
            ...
            @"taskDetail":@{
                ...
                @"cellContents":@[
                    @"2025/01/01 ~ 2025/04/30",
                    @"只要按讚並追蹤台鋼雄鷹官方 Facebook，就能輕鬆拿點數！",
                    @"1",
        ...
        @{
            ...
            @"taskDetail":@{
                ...
                @"cellContents":@[
                    @"2025/01/01 ~ 2025/04/30",
                    @"追蹤台鋼雄鷹官方 Instagram，即可獲得點數獎勵！隨時掌握最新賽事資訊、精彩花絮。",
                    @"1",
                    @[@"參加資格：活動期間內，按讚並追蹤官方 IG 的球迷即可獲得點數。",
                      @"活動達成條件：成功按讚並追蹤官方 IG，即觸發點數獎勵。",
                      @"點數發送：比賽結束後 24 小時內，自動發放至會員帳戶，可於 App 查詢點數並兌換獎品。"],
                ],
                @"footerContent":@"TAKAO：追蹤 IG，點數 GET！不只拿獎勵，還能看到雄鷹最猛瞬間！還不快來一起追蹤，錯過就虧大啦！📲",
                @"type":@"IG",
                @"status": @"即將開放",
                @"isBluetooth":@NO,
                @"locationType":@0,
        ...
        @{
            ...
            @"taskDetail":@{
                ...
                @"cellContents":@[
                    ...
                    @"4 月限定主打商品 TAKAO 茶包 10 入組 熱銷中！活動期間內，至雄鷹實體店面購買，即可獲得 5 點，好茶好禮一起帶回家！",
                    @"5",
                    @[@"參加資格：活動期間內，於雄鷹實體店面購買 TAKAO 茶包 10 入組。",
