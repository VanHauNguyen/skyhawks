...
{
    if ([teamCode containsString:@"AAA011"]) {
        self.vsLb.text = @"VS 味全龍";
        self.rightImageView.image = [UIImage imageNamed:@"味全龍3x_L"];
        
    }else if ([teamCode containsString:@"ADD011"]){
        self.vsLb.text = @"VS 統一獅";
        self.rightImageView.image = [UIImage imageNamed:@"統一獅3x_L"];
        
    }else if ([teamCode containsString:@"AEO011"]){
        self.vsLb.text = @"VS 富邦悍將";
        self.rightImageView.image = [UIImage imageNamed:@"富邦悍將3x_L"];
