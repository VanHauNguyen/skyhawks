...
-(void)setDataForModel:(EGScheduleModel *)model
{
    ...
    if (result < 1)
    {
        ...
        self.nameNumLb.text = [NSString stringWithFormat:@"%@ %ld",model.FieldAbbe,model.GameSno];
        
        self.rightImageView.image = [UIImage imageNamed:retureHeaderTeamIconImgName(model.HomeTeamCode)];
        self.leftImageView.image = [UIImage imageNamed:retureHeaderTeamIconImgName(model.VisitingTeamCode)];
