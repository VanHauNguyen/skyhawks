...
//        }
        ...
        if ([model.HomeTeamCode isEqualToString:@"AKP011"] ) {
            if (![teamCodeArr containsObject:model.VisitingTeamCode]) {
                [teamCodeArr addObject:model.VisitingTeamCode];
            }
        }else{
            if (![teamCodeArr containsObject:model.HomeTeamCode]) {
                [teamCodeArr addObject:model.HomeTeamCode];
            }
        }
    }
