...
//    [self.navigationController pushViewController:webVc animated:true];
    ...
    NSString *urlStr;
    if ([goodsID isEqualToString:@"more"]) {
        urlStr = @"https://www.tsghawks.com/shop/";
    }else{
        urlStr = goodsID;
    }
    SFSafariViewController *safariVC = [[SFSafariViewController alloc] initWithURL:[NSURL URLWithString:urlStr ? urlStr : @"https://www.tsghawks.com/shop/"]];
    safariVC.delegate = self;
    [self presentViewController:safariVC animated:YES completion:nil];
...
- (void)clickNewMessageForItem:(NSString *)newId
{
    ...
    if ([newId isEqualToString:@"more"]) {
        webVc.webUrl = @"https://www.tsghawks.com/news/";
    }else{
        webVc.webUrl = newId;
    }
    [self.navigationController pushViewController:webVc animated:true];
